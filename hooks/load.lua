...
__loading_addon = 'grayswandir-phantasm-redux'
...
for _, file in ipairs(fs.list '/hooks/grayswandir-phantasm-redux/') do
	if file ~= 'load.lua' then
		dofile('/hooks/grayswandir-phantasm-redux/'..file)
		end
	end
